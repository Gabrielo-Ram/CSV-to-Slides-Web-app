 ...
 *
 */
import { presentationID, setPresentationID, setAuthToken, } from "./globals.js";
 ...
 */
async function createPresentation(companyName, service) {
    ...
    try {
        ...
        throw new Error(`createPresentation(): Could not create presentation ${err}`);
    }
}
//Creates OAuth client to pass into initiateSlides()
export async function createSlidesForUser(companyName, accessToken, companyData) {
 ...
 */
async function initiateSlides(companyName, auth, companyData) {
    try {
